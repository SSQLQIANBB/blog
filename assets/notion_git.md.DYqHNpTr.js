import{_ as i,c as a,o as n,ae as h}from"./chunks/framework.U1Gow_7P.js";const E=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"notion/git.md","filePath":"notion/git.md"}'),t={name:"notion/git.md"};function l(p,s,e,k,r,g){return n(),a("div",null,s[0]||(s[0]=[h(`<h2 id="仓库管理" tabindex="-1">仓库管理 <a class="header-anchor" href="#仓库管理" aria-label="Permalink to &quot;仓库管理&quot;">​</a></h2><div class="language-markdown vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">markdown</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-light-font-weight:bold;--shiki-dark:#79B8FF;--shiki-dark-font-weight:bold;"># 初始化：添加 B 为 upstream</span></span>
